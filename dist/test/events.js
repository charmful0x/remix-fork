...
describe('Events', () => {
    ...
    describe('eth_getLogs', () => {
        it('should deploy 2 contracts which emit events and retrieve these events using different block ranges', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const accounts = yield web3.eth.getAccounts();
                // deploy the contract "test".
                const receiptTest = yield web3.eth.sendTransaction({
                    from: accounts[0],
                    gas: 1000000,
                ...
                const receiptOwner = yield web3.eth.sendTransaction({
                    from: accounts[0],
                    gas: 1000000,
                ...
                const testLogs = yield web3.eth.getPastLogs({
                ...
                let ownerLogs = yield web3.eth.getPastLogs({
                ...
                ownerLogs = yield web3.eth.getPastLogs({
                    address: receiptOwner.contractAddress,
                    fromBlock: 2,
                    toBlock: 'latest',
                    topics: ['0x342827c97908e5e2f71151c08502a66d44b6f758e3ac2f1de95f02eb95f0a735', '0xdcd9c7fa0342f01013bd0bf2bec103a81936162dcebd1f0c38b1d4164c17e0fc']
